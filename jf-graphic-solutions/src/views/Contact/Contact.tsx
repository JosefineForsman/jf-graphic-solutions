      ...
      <section className="contact__container">
        ...
        <section>
          ...
          <aside className="contact__social-media">
            ...
            <a href="https://www.facebook.com/profile.php?id=100066812072840" target="_blank" rel="noopener noreferrer" aria-label="Visit Facebook page" className="contact__text">
            Go to our facebook page
            </a>
          </aside>
          <aside className="contact__social-media">
            <img src={instagram} alt="Instagram icon" className="social-media-icon" />
            <a href="https://www.instagram.com/jfgraphicsolutions" target="_blank" rel="noopener noreferrer" aria-label="Visit Instagram profile" className="contact__text">
              Go to our instagram page
            </a>
          </aside>
          <aside className="contact__social-media">
            <img src={youtube} alt="YouTube icon" className="social-media-icon" />
            <a href="https://www.youtube.com/@johnnyforsman3054" target="_blank" rel="noopener noreferrer" aria-label="Visit YouTube channel" className="contact__text">
